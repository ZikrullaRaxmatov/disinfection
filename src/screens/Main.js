        ...
        <div className='container' id='main' >
            <div className='row mt-5' >
                ...
                <div className='z-1 position-absolute col-md-4 text-center z-0 position-absolute top-2 end-0 ' data-aos="fade-left" data-aos-duration="5000" >
                    <h1 className='mt-5'>{t("main.title")}</h1>
                    <p className='mt-3'>{t("main.body")}</p>
                    <a href="#contact" className='btn mt-5 mt-md-4' style={{ backgroundColor: "#5cad00", color: "white" }} >{t("main.btn")}</a>
                </div>
            </div>
        </div>
    );
